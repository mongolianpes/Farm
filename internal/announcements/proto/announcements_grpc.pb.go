...
type AnnouncementsClient interface {
	...
	CreateAnnouncement(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateAnnouncementRequest, CreateAnnouncementResponse], error)
...
func (c *announcementsClient) CreateAnnouncement(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateAnnouncementRequest, CreateAnnouncementResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Announcements_CreateAnnouncementClient = grpc.BidiStreamingClient[CreateAnnouncementRequest, CreateAnnouncementResponse]
...
type AnnouncementsServer interface {
	...
	CreateAnnouncement(grpc.BidiStreamingServer[CreateAnnouncementRequest, CreateAnnouncementResponse]) error
...
func (UnimplementedAnnouncementsServer) CreateAnnouncement(grpc.BidiStreamingServer[CreateAnnouncementRequest, CreateAnnouncementResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Announcements_CreateAnnouncementServer = grpc.BidiStreamingServer[CreateAnnouncementRequest, CreateAnnouncementResponse]
